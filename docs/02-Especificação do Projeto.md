...
| ------ | ------------------------------------------------------------------------------------------------------- | ---------- |
| RF-001 | O sistema deve permitir que o administrador cadastre um novo funcionário administrador ou atendente (nome, cargo, email, contato)          | ALTA       |
| RF-002 | O sistema deve permitir que o administrador cadastre os serviços oferecidos pelo salão                  | ALTA      |
...
| RF-006 | O sistema deve permitir que o administrador associe um novo usuário ao seu login do Google                    | MÉDIA      |
...
| RF-008 | O sistema deve permitir que o administrador filtre os procedimentos já realizados por data, serviço, cliente ou atendente responsável                  | MÉDIA       |
...
| RF-013 | O sistema deve permitir que o administrador emita um relatório em PDF a partir dos filtros de procedimentos já realizados                                 | MÉDIA       |
...
Com diagramas bem organizados que permitem gerenciar o tempo nos projetos, o administrador de projetos agenda e coordena tarefas dentro de um projeto para estimar o tempo necessário de conclusão.
...
[Ir para Quadro de tarefas](https://github.com/orgs/ICEI-PUCMinas-PSG-SI-TI/projects/119/views/1)
